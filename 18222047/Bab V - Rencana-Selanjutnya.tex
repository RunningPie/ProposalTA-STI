...
Arsitektur sistem akan diimplementasikan menggunakan tumpukan teknologi (\textit{tech stack}) berikut:
...
Rincian fokus kegiatan per bulan adalah sebagai berikut:
...
Untuk mengukur keberhasilan sistem dalam memitigasi isolasi pembelajaran, pengujian dilakukan menggunakan metode \textbf{\textit{Controlled Lab Study}} (Studi Laboratorium Terkontrol) dengan desain \textit{One-Group Pretest-Posttest}. Pendekatan sesi tunggal intensif ini dipilih untuk mengisolasi variabel pengganggu (\textit{confounding variables}) seperti pembelajaran eksternal di kelas, sehingga peningkatan kompetensi dapat diatribusikan secara langsung pada interaksi sistem, sekaligus meminimalkan gangguan terhadap jadwal akademik partisipan (non-invasif).
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|p{0.25\textwidth}|c|c|c|}
        ...
        \hline
        R-02 & Akurasi estimasi awal (\textit{cold-start}) rendah & 3 & 4 & \textbf{12 (Sedang)} \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabular}{|p{0.1\textwidth}|p{0.3\textwidth}|p{0.5\textwidth}|}
        ...
        \hline
        \textbf{R-03} & Siswa menilai terlalu murah hati/pelit. & Risiko ini diminimalkan dengan penggunaan rubrik terstruktur berbasis Taksonomi Bloom. Selain itu, skor kualitas asesmen divalidasi secara objektif oleh \textit{Multi-LLM Voting}, sehingga bias siswa tidak memengaruhi skor kompetensi penilai. \\
        \hline
    \end{tabular}
\end{table}