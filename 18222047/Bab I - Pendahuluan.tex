...
konvensional. Ketiadaan sistem di domain pendidikan saat ini 
yang mampu meminimalkan efek dari isolasi pembelajaran ini menjadi
masalah kesenjangan teknologi utama.

Maka dari itu, permasalahan utama yang ingin diselesaikan adalah:
\begin{enumerate}
  \item Implementasi purwarupa sistem
  asesmen adaptif seperti apa yang mampu meminimalkan efek
  \textit{overpersonalization} dengan mengintegrasikan metrik penilaian
  individual ke dalam mekanisme pembelajaran kolaboratif?
  \item Seberapa efektif purwarupa sistem dalam mempertahankan
  fungsionalitas adaptif (personalisasi) sekaligus memfasilitasi
  interaksi
...
asesmen adaptif kolaboratif yang dirancang untuk meminimalkan efek
\textit{overpersonalization} dalam lingkungan pembelajaran}.

Secara spesifik, tujuan penelitian ini adalah:
\begin{enumerate}
  \item Mengimplementasi sistem terintegrasi antara algoritma asesmen adaptif
  ...
  efektivitas sistem dalam memberikan pengalaman belajar yang adaptif tanpa
